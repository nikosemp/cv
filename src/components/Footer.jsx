const Footer = () => {
  ...
  return (
    <footer className="py-12 relative z-10">
      <div className="container mx-auto px-4 glass-container p-8 rounded-lg">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <p className="mt-2 text-gray-300 max-w-md">
              A professional web developer specializing in creating beautiful and functional websites and applications.
            </p>
          </div>
          
          <div className="flex flex-col items-center md:items-end">
            <div className="flex space-x-4 mb-4">
              <a href="#" className="glass-container p-2 rounded-full hover:bg-white/10 transition duration-300">
        ...
        <div className="mt-8 pt-8 border-t border-white/10 text-center">
          ...
          <p className="text-gray-300">Designed and built with ❤️ using React and Tailwind CSS</p>
        </div>
      </div>
    </footer>
  );
